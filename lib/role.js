...
export const addActors = async () => {
  const actors = [
    {
      displayName: "Henk Kaasmaker",
      approved: true,
      email: "henk.kaasmaker@unknown.com",
      isOnline: true,
      role: roles.actor,
    },
    {
      displayName: "Mei Lin Li",
      approved: true,
      email: "meilin.li@unknown.com",
      isOnline: true,
      role: roles.actor,
    },
    {
      displayName: "Shaniqua Khumalo",
      approved: true,
      email: "shaniqua.khumalo@unknown.nl",
      isOnline: true,
      role: roles.actor,
    },
  ];
